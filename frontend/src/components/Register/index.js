        ...
        <form className={style.center} onSubmit={(e) => handleSubmit(e)} noValidate>
          ...
          <div className={style.forgot}>
            <div className={style.checkbox}>
              ...
              <label htmlFor="remember">By creating an account you agree to the terms of use and our privacy policy</label>
            </div>
          </div>
          <Button type="submit" name="Sign Up" />
          <div className={style.signUp}>Already have an account?<button type='button' onClick={() => navigate("/login")}>Log in</button></div>
        </form>
      </div>
    </>
  );
